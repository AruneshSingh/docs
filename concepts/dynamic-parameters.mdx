...
<CardGroup cols={2}>
<Card title="Query Time Weights" icon="play" href="https://colab.research.google.com/github/superlinked/superlinked/blob/main/notebook/feature/query_time_weights.ipynb">
Explore how to set weights at query definition to experiment and optimize without re-embedding your dataset.
</Card>

<Card title="Dynamic Parameters" icon="sliders" href="https://colab.research.google.com/github/superlinked/superlinked/blob/main/notebook/feature/dynamic_parameters.ipynb">
...
<CodeGroup>
```python Body Query - Text Focused
body_query = (
    Query(
        paragraph_index,
        weights={
...
```python Like Query - Popularity Focused
like_query = (
    Query(
        paragraph_index,
        weights={
...
*Body Query Results (text similarity prioritized):*
|     | body                                                  | like_count | id          |
| --- | ----------------------------------------------------- | ---------- | ----------- |
...
*Like Query Results (like count prioritized):*
...
It’s time to query!
You now fill in your placeholder Params with weights, and generate results. To see how different query execution weights alter results, you run two queries with different weightings:

<CodeGroup>
```python Text-Focused Dynamic Query
...
```python Popularity-Focused Dynamic Query
