...
<Info>
  🚀 Try it out:
  [hotel-search-recipe.superlinked.io](https://hotel-search-recipe.superlinked.io/)
</Info>

<Info>
  💻 Github repo:
  [here](https://github.com/superlinked/superlinked-recipes/tree/main/projects/hotel-search)
</Info>
