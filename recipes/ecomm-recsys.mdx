...
<Info>
  🚀 Try it out:
  [recsys-nlq-demo.superlinked.io/](https://recsys-nlq-demo.superlinked.io/)
</Info>

<Info>
  💻 [Github
  repo](https://github.com/superlinked/superlinked-recipes/tree/main/projects/e-commerce)
  - full version with natural language search coming soon
</Info>
...
For a complex query like _a mens shirt with stripes and under 90 $_ the following
...
<Info>
  🚀 Try it out:
  [e-commerce-recsys-recipe.superlinked.io](https://recsys-nlq-demo.superlinked.io/)
</Info>
